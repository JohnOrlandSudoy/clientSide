...
export const AuthView = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a4d6d] via-[#2563a5] to-[#1e5a7d] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md border border-gray-100">
        <div className="text-center mb-6">
          <div className="w-32 h-32 mx-auto mb-4 bg-gradient-to-br from-[#1a4d6d] to-[#2563a5] rounded-full flex items-center justify-center shadow-lg p-4">
            <img
              src="/tapbos.png"
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-[#1a4d6d] to-[#2563a5] text-white py-3 rounded-lg hover:from-[#2563a5] hover:to-[#1a4d6d] transition-all font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 hover:scale-[1.02] disabled:opacity-60"
            disabled={submitting}
          >
