      ...
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <img
            src="/tapbos.png"
            alt="TapBoss Logo"
            className="h-16 w-16 rounded-full object-contain border-3 border-white shadow-2xl bg-white p-1 ring-2 ring-orange-500 ring-offset-2 ring-offset-transparent"
          />
          <div className="hidden sm:block">
            <h1 className="text-white text-xl font-bold tracking-tight">TapBoss</h1>
